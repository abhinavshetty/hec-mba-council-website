...
export class AuthenticationService {
  ...
  currentUserObject = { userEmail: 'association.mbacouncil@hec.edu', userName: 'President', userRole: UserRoles.ADMIN_ACCESS, userClub: 'MBA Council' };

  constructor(private http: HttpClient, private router: Router) {
    // localStorage.set('currentUser', currentUserObject);

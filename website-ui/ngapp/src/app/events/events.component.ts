...
import { AuthenticationService, CommonFunctions, EventService } from 'app/shared/services';
...
export class EventsComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        if (this.currentUser.userRole == UserRoles.CLUB_ACCESS) {
            ...
            this.eventService.getPendingEventsForSubmitter(this.currentUser.userClub).subscribe(res => {
                console.log(res);
                this.eventService.convertJdbcDatesToAngularInList(res);
                console.log(res);
    ...
    onAddButtonClick() {
        ...
        this.chosenEvent.host = this.currentUser.userClub;
        this.chosenEvent.submitterUserName = this.currentUser.userName;
    }
